/*---------------------------------------------------------------
Created by Iain Zwiebel - March 27th 2021
...
create a web server. This is then accessed via the IOS app "Ring Rewards!" 
which tracks your activity and gives 'spins' based on those values.

Requires the CheapStepper library by tyhenry
...
const char* ssid = ""; // Enter your network SSID here
...
void handleSpins() {
  ...
  if (numSpins) {
    stepper.moveDegrees(clockwise, 180*numSpins);
